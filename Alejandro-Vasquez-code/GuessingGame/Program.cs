...
while (true)
{
    ...
    {
        Console.WriteLine("You guessed incorrectly, your guess is high");    // i think these were flipped
    }
    else
    {
        Console.WriteLine("You guessed incorrectly, your guess is low");   // i think these were flipped
    }

    Console.WriteLine("Past Guess: " + pastGuess + " Current guess: " + currentGuess);
    // *************************
    // implement WarmOrCold() here...
    if (pastGuess != null)
    {
...
public static class GuessingGame
{
    ...
    public static int WarmOrCold()
    {
        //implement a way to abstract the main code and put it here... (later)
    }
}